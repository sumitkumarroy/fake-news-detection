...
model = pickle.load(open("D:\\python\\FAKE_NEWS_DETECTION\\Dataset\\artifacts\\model.pkl", "rb"))
vectorizer = pickle.load(open("D:\\python\\FAKE_NEWS_DETECTION\\Dataset\\artifacts\\vertorizer.pkl", "rb"))
